...
#define LOGE(format,...) LOG(LOG_FMT(E, format), ##__VA_ARGS__)
#define LOGW(format,...) LOG(LOG_FMT(W, format), ##__VA_ARGS__)
#define LOGI(format,...) LOG(LOG_FMT(I, format), ##__VA_ARGS__)
#define LOGV(format,...) LOG(LOG_FMT(V, format), ##__VA_ARGS__)
